...
from recordlinkage.compare import DateProximityComparison 
from recordlinkage.compare import DateSwap
...
class Compare(BaseCompare):
    ...
    def date_proximity(self, *args, **kwargs):
        """Compare attributes of pairs with date proximity algorithm.

        Shortcut of :class:`recordlinkage.compare.DateProximityComparison`::

            from recordlinkage.compare import DateProximityComparison

            indexer = recordlinkage.Compare()
            indexer.add(DateProximityComparison())

        """
        compare = DateProximityComparison(*args, **kwargs)
        self.add(compare)

        return self
    
    def dateSwap(self, *args, **kwargs):
        """Compare attributes of pairs with date proximity algorithm.
