...
data_filled = df_data.to_dict(orient = 'records')

# Create customized data dictionary
df_data.to_csv("output/custom_data_dict_v23_062424_v2.csv")


# Create a empty data structure in python with all variables are string variables, and column names in capital letters
