...
sg_00811 = pd.read_excel("Task5\Reference Tables - Overall Stage Group Long 2023.xlsx", sheet_name="TNM_00811_new")

# Step 2: Sort and remove duplicates
sg_00811 = sg_00811.drop_duplicates(subset=['schemaid', 't_value', 'n_value', 'm_value', 'descriptor', 'p_blood_value'])

# Step 3: Query to create the Invalid_00811 table
query = """
SELECT DISTINCT
    a.acb_no,
    a.mal_no, 
...
Invalid_00811 = pd.read_sql_query(query, con=conn)
