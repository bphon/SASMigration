# path and posttherapy stage group different conversion table 
...
class TNMProcessor:
    ...
    def process_sg_TNM00170(self):
        sg_TNM00170_sorted = self.import_and_sort_data("TNM_00170", ['schemaid', 't_value', 'n_value', 'm_value', 'descriptor'])
        ...
        JOIN sg_TNM00170_sorted b ON a.schema_id = b.schemaid
        WHERE
            (
...
invalid_stage_00170 = tnm_processor.process_sg_TNM00170()

print(invalid_stage_00170)
